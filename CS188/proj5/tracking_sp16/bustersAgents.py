...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for pos in mostLikelyPositions:
            checkDistance = self.distancer.getDistance(pacmanPosition, pos)
        ...
        for a in legal:
            ...
            checkDistance = self.distancer.getDistance(successorPosition, closestGhostPos)
            if checkDistance < mazeDistance:
                action = a
                mazeDistance = checkDistance
        return action
